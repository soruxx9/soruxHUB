...
local Window = Library.CreateLib("soruxHUB by soruxx9", "RJTheme3")

local Tab = Window:NewTab("Главная")
local Section = Tab:NewSection("Главные функции")


Section:NewSlider("Скорость", "Тащите ползунок что-бы менять свою скорость - всё просто.", 150, 0, function(ws)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = ws
end)


Section:NewButton("Скорость по умолчанию", "Скорость по умолчанию", function()
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16
end)


Section:NewSlider("Сила прыжка", "Тащите ползунок что-бы менять свою силу прыжка - всё просто.", 150, 0, function(jp)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = jp
end)


Section:NewButton("Сила прыжка по умолчанию", "Сила прыжка по умолчанию", function()
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50
end)

Section:NewButton("Полёт", "Полёт.", function()
...
local Tab = Window:NewTab("Персонаж")
local Section = Tab:NewSection("Настройки персонажа")
...
Section:NewToggle("Глитч на скорость", "Глитч на скорость. ", function(state)
    if state then
...
Section:NewButton("Пак анимаций (все видят)", "Заменяет ваши анимации на популярные", function()
    while true do
...
Section:NewButton("Ресет", "Ресет персонажа", function()
